...
- If mode is `engram`:
  ...
  **Save project context**:
  ...
  (See `~/.cursor/skills/_shared/engram-convention.md` for full naming conventions.)
- If mode is `openspec`: Read and follow `~/.cursor/skills/_shared/openspec-convention.md`. Run full bootstrap.
...
Follow the same logic as the `skill-registry` skill (`~/.cursor/skills/skill-registry/SKILL.md`):
...
See `~/.cursor/skills/skill-registry/SKILL.md` for the full registry format and scanning details.
...
Persist project context following `~/.cursor/skills/_shared/engram-convention.md` with title and topic_key `sdd-init/{project-name}`.
