...
- **openspec**: Read and follow `~/.cursor/skills/_shared/openspec-convention.md`.
...
- **Size budget**: Proposal artifact MUST be under 400 words. Use bullet points and tables over prose.
